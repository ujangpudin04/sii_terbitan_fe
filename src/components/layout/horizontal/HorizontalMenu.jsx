...
import RenderMenu from "@components/layout/horizontal/RenderMenu";
  ...
  return (
    ...
    >
      {isLoading ? (
        ...
        >
          {menuData && (
            <RenderMenu menuItems={menuData} dictionray={dictionary} />
          )}
          {/* <SubMenu
          ...
          >
            <SubMenu
              ...
              icon={<i className="ri-shopping-bag-3-line" />}
            >
              <MenuItem href={`/${locale}/apps/ecommerce/dashboard`}>
              ...
              <MenuItem href={`/${locale}/apps/ecommerce/referrals`}>
                {dictionary["navigation"].referrals}
              </MenuItem>
              <MenuItem href={`/${locale}/apps/ecommerce/settings`}>
            ...
            <SubMenu
              ...
              icon={<i className="ri-car-line" />}
            >
              <MenuItem href={`/${locale}/apps/logistics/dashboard`}>
                {dictionary["navigation"].dashboard}
              </MenuItem>
              <MenuItem href={`/${locale}/apps/logistics/fleet`}>
            ...
            <SubMenu
              ...
              icon={<i className="ri-file-list-2-line" />}
            >
